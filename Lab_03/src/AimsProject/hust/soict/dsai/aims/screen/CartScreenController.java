...
import Lab_03.src.AimsProject.hust.soict.dsai.aims.media.Media;
import Lab_03.src.AimsProject.hust.soict.dsai.aims.media.Playable;
...
public class CartScreenController {
    ...
    private void initialize() {
        ...
        tblMedia.setItems(this.cart.getItemsOrdereded());
        ...
        filteredMediaList = new FilteredList<>(cart.getItemsOrdereded(), null);
